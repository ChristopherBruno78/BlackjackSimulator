...
class IllustriousEighteenTable(strategy: CountingStrategy) {
    ...
    init {
        ...
        strategy.setDeviation(Action.Split, HandState(pair(20), upCard = Rank.Five), atIndex = 5)
        strategy.setDeviation(Action.Split, HandState(pair(20), upCard = Rank.Six), atIndex = 4)
        ...
        strategy.setDeviation(Action.Split, HandState(soft(12), upCard = Rank.Two), atIndex = 3)
